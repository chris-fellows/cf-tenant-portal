...
namespace CFTenantPortal.Views.Components
{
    public class DocumentListCompViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(DocumentListVM documentList)
        {            
            return await Task.FromResult((IViewComponentResult)View("DocumentList", documentList));
        }
